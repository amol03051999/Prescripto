...
const AllAppointment = () => {
  ...
  return (
    <div className='w-full max-w-6xl m-5'>
      <h1 className='mb-3 text-lg font-medium text-gray-800'>All Appointments</h1>
      
      <div className='bg-white border rounded text-sm max-h-[80vh] min-h-[60vh] overflow-y-auto'>
        {/* Header */}
        <div className={`hidden sm:grid ${gridColumns} py-3 px-6 border-b bg-gray-50 font-medium`}>
