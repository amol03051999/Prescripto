  ...
  return (
    ...
    <div>
    {
      doctors.slice(0,2).map((item,index)=>(
        ...
        <button className='text-sm text-stone-500 text-center sm:s'>Pay Online</button>
        <button className='text-sm text-stone-500 text-center sm:s'>Cancel Appointment</button>
        </div>
