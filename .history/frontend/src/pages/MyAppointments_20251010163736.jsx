  ...
  return (
    ...
    <div>
    {
      doctors.slice(0,2).map((item,index)=>(
        ...
        <button className='text-sm text-stone-500 text-center sm:min-w'>Pay Online</button>
        <button className='text-sm text-stone-500 text-center sm:min-w'>Cancel Appointment</button>
        </div>
