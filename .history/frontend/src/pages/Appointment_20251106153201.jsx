...
const navigate = useNavigate();
  ...
  const bookAppointment = async () => {
    ...
    try{
      ...
      const {data} = await fetch(backendUrl + '/api/user/book-appointment',{docId,slotDate,slotTime},{headers;{token},method:'POST'})
    }catch(error){
      toast.error('Please select slot to book appointment',error);
      return;
    }
  }
